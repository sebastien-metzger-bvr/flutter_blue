...
typedef GPB_ENUM(ProtosMtuMessage_FieldNumber) {
  ProtosMtuMessage_FieldNumber_RemoteId = 1,
  ProtosMtuMessage_FieldNumber_Mtu = 2,
};

@interface ProtosMtuMessage : GPBMessage
