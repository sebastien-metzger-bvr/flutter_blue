...
#pragma mark - ProtosMtuMessage

@implementation ProtosMtuMessage

@dynamic remoteId;
@dynamic mtu;

typedef struct ProtosMtuMessage__storage_ {
  uint32_t _has_storage_[1];
  int32_t mtu;
  NSString *remoteId;
} ProtosMtuMessage__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "remoteId",
        .dataTypeSpecific.className = NULL,
        .number = ProtosMtuMessage_FieldNumber_RemoteId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ProtosMtuMessage__storage_, remoteId),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "mtu",
        .dataTypeSpecific.className = NULL,
        .number = ProtosMtuMessage_FieldNumber_Mtu,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ProtosMtuMessage__storage_, mtu),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt32,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosMtuMessage class]
                                     rootClass:[ProtosFlutterblueRoot class]
                                          file:ProtosFlutterblueRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ProtosMtuMessage__storage_)
                                         flags:GPBDescriptorInitializationFlag_None];
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  }
