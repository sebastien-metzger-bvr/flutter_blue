...
class BluetoothDevice {
  ...
  Future<int> requestMtu(int mtu) async {
    ...
    return await FlutterBlue.instance._mtuChannel
        .receiveBroadcastStream()
        .map((buffer) => new protos.MtuMessage.fromBuffer(buffer))
        .where((message) => message.remoteId == id.toString())
        .map((message) => message.mtu)
        .first;
  }
