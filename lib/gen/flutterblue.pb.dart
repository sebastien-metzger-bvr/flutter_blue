...
class AdvertisementData_ManufacturerDataEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('AdvertisementData.ManufacturerDataEntry')
  ...
  AdvertisementData_ManufacturerDataEntry.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AdvertisementData_ManufacturerDataEntry.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AdvertisementData_ManufacturerDataEntry clone() => new AdvertisementData_ManufacturerDataEntry()..mergeFromMessage(this);
  AdvertisementData_ManufacturerDataEntry copyWith(void Function(AdvertisementData_ManufacturerDataEntry) updates) => super.copyWith((message) => updates(message as AdvertisementData_ManufacturerDataEntry));
  $pb.BuilderInfo get info_ => _i;
  static AdvertisementData_ManufacturerDataEntry create() => new AdvertisementData_ManufacturerDataEntry();
  static $pb.PbList<AdvertisementData_ManufacturerDataEntry> createRepeated() => new $pb.PbList<AdvertisementData_ManufacturerDataEntry>();
  static AdvertisementData_ManufacturerDataEntry getDefault() => _defaultInstance ??= create()..freeze();
  ...
  static void $checkItem(AdvertisementData_ManufacturerDataEntry v) {
    if (v is! AdvertisementData_ManufacturerDataEntry) $pb.checkItemFailed(v, _i.qualifiedMessageName);
  }
...
class AdvertisementData_ServiceDataEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('AdvertisementData.ServiceDataEntry')
    ..aOS(1, 'key')
    ..a<List<int>>(2, 'value', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  AdvertisementData_ServiceDataEntry.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AdvertisementData_ServiceDataEntry.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AdvertisementData_ServiceDataEntry clone() => new AdvertisementData_ServiceDataEntry()..mergeFromMessage(this);
  AdvertisementData_ServiceDataEntry copyWith(void Function(AdvertisementData_ServiceDataEntry) updates) => super.copyWith((message) => updates(message as AdvertisementData_ServiceDataEntry));
  $pb.BuilderInfo get info_ => _i;
  static AdvertisementData_ServiceDataEntry create() => new AdvertisementData_ServiceDataEntry();
  static $pb.PbList<AdvertisementData_ServiceDataEntry> createRepeated() => new $pb.PbList<AdvertisementData_ServiceDataEntry>();
  static AdvertisementData_ServiceDataEntry getDefault() => _defaultInstance ??= create()..freeze();
  static AdvertisementData_ServiceDataEntry _defaultInstance;
  static void $checkItem(AdvertisementData_ServiceDataEntry v) {
    if (v is! AdvertisementData_ServiceDataEntry) $pb.checkItemFailed(v, _i.qualifiedMessageName);
  }
...
class AdvertisementData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('AdvertisementData')
    ...
    ..aOB(3, 'connectable')
    ..pp<AdvertisementData_ManufacturerDataEntry>(4, 'manufacturerData', $pb.PbFieldType.PM, AdvertisementData_ManufacturerDataEntry.$checkItem, AdvertisementData_ManufacturerDataEntry.create)
    ..pp<AdvertisementData_ServiceDataEntry>(5, 'serviceData', $pb.PbFieldType.PM, AdvertisementData_ServiceDataEntry.$checkItem, AdvertisementData_ServiceDataEntry.create)
    ..pPS(6, 'serviceUuids')
    ..hasRequiredFields = false
  ;
...
class MtuMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('MtuMessage')
    ..aOS(1, 'remoteId')
    ..a<int>(2, 'mtu', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  MtuMessage() : super();
  MtuMessage.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  MtuMessage.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  MtuMessage clone() => new MtuMessage()..mergeFromMessage(this);
  MtuMessage copyWith(void Function(MtuMessage) updates) => super.copyWith((message) => updates(message as MtuMessage));
  $pb.BuilderInfo get info_ => _i;
  static MtuMessage create() => new MtuMessage();
  static $pb.PbList<MtuMessage> createRepeated() => new $pb.PbList<MtuMessage>();
  static MtuMessage getDefault() => _defaultInstance ??= create()..freeze();
  static MtuMessage _defaultInstance;
  static void $checkItem(MtuMessage v) {
    if (v is! MtuMessage) $pb.checkItemFailed(v, _i.qualifiedMessageName);
  }
  ...
  set mtu(int v) { $_setSignedInt32(1, v); }
  bool hasMtu() => $_has(1);
